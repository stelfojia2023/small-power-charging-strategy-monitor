...
skeleton under reports/. It does not replace Codex research; it prepares the
...
OPTIONS = {
    ...
    "4": {
        "label": "单一竞品档案",
        "period": "ad-hoc",
        "report_dir": REPORTS / "competitor_dossiers",
    ...
    "5": {
        "label": "证据矩阵刷新",
        "period": "ad-hoc",
        "report_dir": REPORTS / "evidence_matrix",
    ...
    "6": {
        "label": "行动跟踪表",
        "period": "ad-hoc",
        "report_dir": REPORTS / "action_trackers",
    ...
    "9": {
        "label": "海外 AC 专题",
        "period": "ad-hoc",
        "report_dir": REPORTS / "overseas_ac",
    ...
    "10": {
        "label": "标准与认证专题",
        "period": "ad-hoc",
        "report_dir": REPORTS / "certification",
    ...
    "12": {
        "label": "管理层一页纸",
        "period": "ad-hoc",
        "report_dir": REPORTS / "management_briefs",
    ...
    "13": {
        "label": "研发资源决策",
        "period": "ad-hoc",
        "report_dir": REPORTS / "rd_decisions",
    ...
    "14": {
        "label": "TCO 低价反制",
        "period": "ad-hoc",
        "report_dir": REPORTS / "tco_countermeasures",
...
def make_codex_prompt(instruction: str, extra: str, path: Path) -> str:
    ...
    return (
        "使用 ./strategy-monitor 这个 skill，"
        f"{instruction} {extra_text} "
        "读取 strategy-monitor/inputs/、sources/、cache/、logic/ 中的相关文件，按证据分级和战略阈值执行，"
